...
<head>
    ...
    <title>Error 403 - Agregator Jurnal PKTJ</title>
...
<body class="bg-[#F8FAFC] min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full bg-white rounded-3xl shadow-xl overflow-hidden relative border border-slate-100">
        ...
        <div class="relative z-10 p-8 sm:p-12 text-center">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-800 mb-4">Akses Ditolak</h1>
            
            <p class="text-slate-500 mb-10 max-w-md mx-auto leading-relaxed">Maaf, Anda tidak memiliki izin yang cukup untuk mengakses halaman atau fitur ini.</p>
