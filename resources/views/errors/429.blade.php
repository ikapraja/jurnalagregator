...
<head>
    ...
    <title>Error 429 - Agregator Jurnal PKTJ</title>
...
<body class="bg-[#F8FAFC] min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full bg-white rounded-3xl shadow-xl overflow-hidden relative border border-slate-100">
        ...
        <div class="relative z-10 p-8 sm:p-12 text-center">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-800 mb-4">Terlalu Banyak Permintaan</h1>
            
            <p class="text-slate-500 mb-10 max-w-md mx-auto leading-relaxed">Anda telah melakukan terlalu banyak pencarian dalam waktu singkat. Mohon tunggu beberapa saat sebelum mencoba lagi.</p>
