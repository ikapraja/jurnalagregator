...
<body class="bg-[#1E3A8A] flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-6">
            ...
            <h1 class="text-[22px] font-extrabold text-[#1E3A8A] tracking-wide">Admin Dashboard</h1>
        </div>
        ...
        <form action="{{ route('admin.authenticate') }}" method="POST">
            ...
            <button type="submit" class="w-full bg-[#1E3A8A] text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-900 transition shadow-lg mt-2">
                Masuk Sistem
            </button>
        </form>
    </div>
