...
$newFooter = <<<HTML
    <!-- Footer -->
    <footer class="bg-[#1E3A8A] border-t border-blue-900 pt-16 pb-8 mt-auto text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-12 mb-16">
                <!-- Column 1: Brand & Desc -->
                <div class="flex flex-col gap-6">
                    ...
                    <p class="text-[14px] font-medium text-blue-100/80 leading-relaxed text-justify">
